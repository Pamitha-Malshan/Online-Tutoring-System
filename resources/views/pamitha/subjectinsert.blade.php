...
{{csrf_field()}}
  ...
  <input type="text"  name="code" id="code" maxlength="4" minlength="4" placeholder="Enter 4 character code"  class="dk"><br><br>
  
  <label>Enter Subject name :</label></br>
  <select name="subject" id="name" class="dk">
  ...
  <select name="grade" id="grade" class="dk" >
   ...
   <input type="number"  name="qut" id="tute"  class="dk"><br><br>
