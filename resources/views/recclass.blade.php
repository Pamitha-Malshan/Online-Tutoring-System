...
<div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <input type="date" class="form-control" placeholder="enter recorded date" name="recdate">
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="enter handler" name="handler">
        </div>
    </div>
