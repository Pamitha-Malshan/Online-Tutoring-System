...
<body>
    ...
    <div class="container" style="width: 60%;">
        ...
        <div class="border border-dark border-2" style="padding: 20px; margin: 10px;">
            ...
            <form action="/updateExamNext" method="POST">
            {{csrf_field()}}

                <input type="hidden" name="id" value="{{$updateExam->id}}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" aria-label="Default select example" name="selectClass">
                            <option selected>{{$updateExam->class}}</option>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" aria-label="Default select example" name="selectExam">
                            <option selected>{{$updateExam->exam}}</option>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" aria-label="Default select example" name="selectType">
                            <option selected>{{$updateExam->examType}}</option>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="date" class="form-control" id="inputDate" name="examDate" value="{{$updateExam->examDate}}">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="row">
                            <div class="col">
                              <input type="time" class="form-control" name="startTime" value="{{$updateExam->startTime}}">
                            </div>
                            <div class="col-sm-1"> <p style="text-align: center;"> to </p> </div>
                            <div class="col">
                              <input type="time" class="form-control" name="endTime" value="{{$updateExam->endTime}}">
                            </div>
                          </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" id="inputDuration" placeholder="00 min" name="duration" value="{{$updateExam->duration}}">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" id="inputTotMarks" name="totMarks" value="{{$updateExam->totMarks}}">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" id="inputNoQues" name="noOfQues" value="{{$updateExam->noOfQues}}">
                    </div>
                </div>

                <div class="text-center">

                    <button type="submit" class="btn btn-success" style="width: 40%;">Update Exam</button>
                    <button type="submit" class="btn btn-danger" style="width: 40%;">Cancel</button>
                </div>
